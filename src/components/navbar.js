...
`
const Navbar = () => {
  const {openSidebar, isSidebarOpen, closeSidebar, sum} = useGlobalContext()
  return (<>
    <Container>
        <Wrapper>
            <Left>
            ...
            <Right>
              <MenuItems type='no-responsive'>Register</MenuItems>
              <MenuItems type='no-responsive'>Sign in</MenuItems>
              <MenuItems>
              <Link to='/cart' style={{textDecoration: 'none'}}>
              <Badge badgeContent={sum} color="primary" style={{color: 'black'}}>
